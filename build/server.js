...
app.get('/', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _yield$conn$query, _yield$conn$query2, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _conn.conn.query('select * from board order by id DESC');
        case 2:
          _yield$conn$query = _context.sent;
          _yield$conn$query2 = _slicedToArray(_yield$conn$query, 1);
          result = _yield$conn$query2[0];
...
app.post('/', function (req, res) {
  ...
  _conn.conn.query(query, [message, nickname]);
  res.redirect('/');
  console.log('hh');
});
app.get('/table', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _conn.conn.query("\n    create table board (\n      id int not null auto_increment primary key,\n      message varchar(1000) not null,\n      nickname varchar(16) not null\n    )");
        case 2:
